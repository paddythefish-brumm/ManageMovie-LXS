...
- Proxmox-Host-Deployment direkt aus einem privaten Git-Repo
...
- Debian 13 ohne X
- HTTPS aktiviert
- Keine Abhängigkeit zu Mac- oder VM-spezifischen Deploy-Skripten
- Privates Git-Repository für Kunden-Deployment
