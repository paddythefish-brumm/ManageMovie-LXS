...
```bash
git clone https://github.com/paddythefish-brumm/ManageMovie-LXS.git && cd ManageMovie-LXS && ./scripts/proxmox/deploy_lxc_on_proxmox.sh --name managemovie-lxs --ip 192.168.52.152 --storage nvme1TB --ctid 206
```
